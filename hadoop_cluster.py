...
instances = ast.literal_eval(config.get('main','hadoop_nodes'))
instances.append('saltmaster')
ec2.create_instances(image_id = image_id, key_name = key_name, instance_type = instance_type, security_group = security_group , instances = instances)